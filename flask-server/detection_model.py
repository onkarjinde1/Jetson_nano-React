...
class ObjectDetector:
    def __init__(self):
        ...
        self.models = {
            ...
            'yolov8s': YOLO("yolov8s.pt").to(self.device),
            'yolov8m': YOLO("yolov8m.pt").to(self.device)
        }
    ...
    def detect(self, frame):
        ...
        for r in results:
            ...
            for box in boxes:
                ...
                x1 = int(x1.item() * (original_width / 640))
                y1 = int(y1.item() * (original_height / 640))
                x2 = int(x2.item() * (original_width / 640))
                y2 = int(y2.item() * (original_height / 640))
